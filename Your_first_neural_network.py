...
#             print("output_error_term:",output_error_term,"| output_error_term_shape:",output_error_term.shape)
#             print("hidden_error_term:",hidden_error_term,"| hidden_error_term_shape:",hidden_error_term.shape)
...
#             print("al:",output_error_term * hidden_outputs)
...
# 普遍预测值要实际的值要高出一些。
# 但是，从12月22日开始，prediction和data之间的差值明显上升了，猜测是出现其他的因素造成数据比predication要低。
